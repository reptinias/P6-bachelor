...
dataset = PartDataset(root = 'Dataset', classification = False, class_choice = None)
dataloader = torch.utils.data.DataLoader(dataset, batch_size=opt.batchSize,
                                          shuffle=True, num_workers=0)

test_dataset = PartDataset(root = 'Dataset', classification = False, class_choice = None, train = False)
